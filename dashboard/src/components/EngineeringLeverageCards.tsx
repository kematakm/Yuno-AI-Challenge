...
export function EngineeringLeverageCards() {
  return (
    <Section
      ...
      title="Where engineering and operational capacity is getting trapped"
        ...
        {TIER_LIST.map((t) => {
          ...
          return (
            <Card key={t.id} accent={t.accent} className="flex flex-col">
              ...
              <h3 className="text-[15px] leading-[1.25] font-semibold" style={{ color: 'var(--ink)' }}>
                {card.headline}
              </h3>

              <ol className="mt-3.5 grid gap-0">
